...
public class PipeAndFilterProblem {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (Map.Entry<String, Integer> grade : filter4.gradesByCourseGroup.entrySet()) {
            System.out.println(grade.getKey() + " " + grade.getValue() / filter4.numberPassing.get(grade.getKey()));
        }
    }
}
